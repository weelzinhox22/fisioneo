...
export default function ProvasPage() {
  ...
  return (
    <div className="relative min-h-screen pb-20">
      ...
      <div 
        ref={headerRef}
        className="relative py-20 md:py-28 mb-16"
      >
        ...
        <div className="relative z-10 container mx-auto px-6">
          <FadeIn className="text-center max-w-3xl mx-auto">
            <motion.span 
              className="px-4 py-1.5 bg-gradient-to-r from-[#B9A9FF]/10 to-[#6EC1E4]/10 rounded-full text-sm font-medium text-[#6EC1E4] inline-block mb-4"
      ...
      {/* Quiz cards grid */}
      <div className="container mx-auto px-6 mb-16" ref={cardsRef}>
        <motion.h2 
