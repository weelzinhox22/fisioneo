    ...
    <div className="container mx-auto px-4 py-8">
      <section className="relative min-h-[80vh] flex items-center justify-center mb-20">
        <div className="absolute inset-0 z-[-1] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-b from-[#F0F9FF]/80 to-[#F7FAFC]/90" />
          <div className="w-full h-full bg-gradient-to-b from-[#F0F9FF] to-[#F7FAFC]" />
        </div>

        <div className="text-center max-w-3xl mx-auto px-4 py-16">
          <ParallaxElement speed={0.3} direction="up">
            <TransformEffect type="scale" intensity={0.5} duration={1}>
              <h1 className="text-4xl md:text-6xl font-bold text-[#333333] mb-6 drop-shadow-sm">
          ...
          <FadeIn delay={0.3} direction="up" distance={30}>
            <p className="text-lg md:text-xl text-[#666666] mb-8 drop-shadow-sm">
              Portal educacional dedicado ao estudo e prática da fisioterapia em recém-nascidos e crianças, com foco em
              desenvolvimento neuromotor, avaliação e intervenção precoce.
            </p>
          </FadeIn>

          <FadeIn delay={0.5} direction="up" distance={30}>
            <div className="flex flex-wrap justify-center gap-4">
              <Transmorph from="circle" to="square" duration={0.5}>
                <Link
                  href="/temas"
                  className="px-6 py-3 bg-gradient-to-r from-[#6EC1E4] to-[#5BA8CB] text-white rounded-lg hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
                >
                  Explorar Temas
                </Link>
              </Transmorph>
              <Transmorph from="circle" to="square" duration={0.5} delay={0.2}>
                <Link
                  href="/provas"
                  className="px-6 py-3 bg-white border border-[#6EC1E4] text-[#6EC1E4] rounded-lg hover:bg-[#F0F9FF] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
                >
