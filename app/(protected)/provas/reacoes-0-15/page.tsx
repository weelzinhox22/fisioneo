...
const questions = [
  {
    question: "Como se desenvolvem as reações posturais nos primeiros 15 meses?",
    options: [
      "Surgem aleatoriamente",
      "Não se desenvolvem",
      "Desenvolvem-se de forma caótica",
      "Seguem uma sequência céfalo-caudal e próximo-distal"
    ],
    correctAnswer: 3,
    explanation: "As reações posturais seguem um desenvolvimento organizado, em sequência céfalo-caudal (da cabeça para os pés) e próximo-distal (do centro para as extremidades)."
  },
  {
    question: "Qual a importância das reações de retificação?",
    options: [
      "Fundamentais para alinhamento corporal e orientação espacial",
      "Não têm importância",
      "Apenas para dormir",
      "Surgem após 2 anos"
    ],
    correctAnswer: 0,
    explanation: "As reações de retificação são essenciais para manter o alinhamento corporal adequado e desenvolver a orientação espacial durante o desenvolvimento motor."
  },
  {
    question: "Como avaliar as reações de proteção em bebês?",
    options: [
      "Não é necessário avaliar",
      "Apenas observar quedas",
      "Observar respostas automáticas para proteção em diferentes posições",
      "Esperar acidentes"
    ],
    correctAnswer: 2,
    explanation: "A avaliação das reações de proteção deve ser feita observando as respostas automáticas do bebê para se proteger em diferentes posições e situações de desequilíbrio."
  },
  {
    question: "Qual a relação entre reações posturais e desenvolvimento motor?",
    options: [
      "Base para aquisição de habilidades motoras e controle postural",
      "Não há relação",
      "Apenas atrapalham",
      "São independentes"
    ],
    correctAnswer: 0,
    explanation: "As reações posturais formam a base para a aquisição de habilidades motoras mais complexas e o desenvolvimento do controle postural adequado."
  },
  {
    question: "Como as reações de equilíbrio evoluem até os 15 meses?",
    options: [
      "Não evoluem",
      "Permanecem iguais",
      "Evoluem aleatoriamente",
      "Progressivamente mais complexas, acompanhando desenvolvimento motor"
    ],
    correctAnswer: 3,
    explanation: "As reações de equilíbrio tornam-se progressivamente mais complexas e refinadas, acompanhando o desenvolvimento motor e as necessidades de estabilidade postural."
  }
]

export default function Reacoes015Page() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 pb-20">
      <div className="container mx-auto px-6 py-8">
        ...
        {!showResults ? (
          <div>
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-gray-800 mb-2">Reações de 0-15 Meses</h1>
